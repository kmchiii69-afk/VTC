...
const CALLS = [
  { id: 1, title: 'Monday · Content Mastermind — Apr 20, 2026', url: 'https://fathom.video/share/bCbqyxEyDv35UsfweeCyY_-idJUnniTJ' },
  { id: 2, title: 'Monday · Content Mastermind — Apr 27, 2026', url: 'https://fathom.video/share/dyAnkbFaVhjcQ1tpBkHsnemMRgSE4Vvk' },
  { id: 3, title: 'Monday · Content Mastermind — May 5, 2026',  url: 'https://fathom.video/share/HwAn2s1MHR4KSdjipnEe9qyY59GzixRP' },
  { id: 4, title: 'Monday · Content Mastermind — May 14, 2026', url: 'https://fathom.video/share/kQedSdngd1cFm6sxAxWVzoGLpgmV1yz2' },
  { id: 5, title: 'Monday · Content Mastermind — May 20, 2026', url: 'https://fathom.video/share/5fUreuoazmq3Myyz6DabwbykR5xdd7UF' },
];
  ...
  return (
    <main style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden', background: '#050403' }}>
      ...
      <div style={{
        ...
        opacity: visible ? 1 : 0, animation: 'fadeUp 0.55s ease forwards',
      }}>
        <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: '10px', letterSpacing: '0.3em',
          ...
          marginBottom: 32, textAlign: 'center' }}>Creative Direction</p>

        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, width: '100%', maxWidth: 520, padding: '0 24px' }}>
