...
// ("Gem Smoke"). Zero dependencies: one WebGL canvas that fills its
// parent. Drop it behind your content with
// <div className="relative"><ShaderBackground className="absolute inset-0" />…
// Adapted from Paper Shaders: https://shaders.paper.design/gem-smoke
...
const UNIFORMS = {
  // VTC brand red (#EE3124), lightened. Ramp: dark base → deep red → lighter
  // brand red (#F55A4E) → soft warm-white highlight.
  colors: [[0.07450980392,0.03137254902,0.02745098039],[0.62745098039,0.10980392157,0.08627450980],[0.96078431373,0.35294117647,0.30588235294],[1,0.92549019608,0.91372549020],[1,0.92549019608,0.91372549020],[1,0.92549019608,0.91372549020],[1,0.92549019608,0.91372549020],[1,0.92549019608,0.91372549020]] as [number, number, number][],
  colorCount: 4,
  scale: 2.140,
  intensity: 0.450,
  paramA: 0.750,
