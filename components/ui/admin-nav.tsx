...
export function AdminNav() {
  ...
  return (
    <div style={{ position: 'sticky', top: 0, zIndex: 20, display: 'flex', justifyContent: 'center', gap: 4, padding: '14px 16px',
      background: 'rgba(26,20,35,0.6)', backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)', borderBottom: `1px solid ${T.border}` }}>
      {LINKS.map((l) => {
